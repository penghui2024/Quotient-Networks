...
def Eval(model, check_point):
    ...
    print("The test accuracy on CIFAR100 test set: {}".format(acc_test))


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument('--model', type=str, default='resnet56', help='choose one model from resnet44, resnet56, resnet110,'
                                                                  ' q44, q56, q110')
    parser.add_argument('--check_point', type=str, default=os.path.join(os.path.dirname(BASE_DIR), "pre_train",
                                                                        "checkpoint_best_resnet56.pkl"), help="checkpoint file path")
