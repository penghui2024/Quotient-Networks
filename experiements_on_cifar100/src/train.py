...
from tools.common_tools import ModelTrainer, plot_line
from tools.cifar100_dataset import CifarDataset
...
if __name__ == "__main__":
    ...
    # config
    train_dir = os.path.join(BASE_DIR, "..", "data", "cifar100_train")
    test_dir = os.path.join(BASE_DIR, "..", "data", "cifar100_test")
    ...
    for epoch in range(start_epoch, MAX_EPOCH):
        ...
        loss_train, acc_train = ModelTrainer.train(train_loader, model, criterion, optimizer, epoch,
                                                              device, MAX_EPOCH)
        loss_valid, acc_valid = ModelTrainer.valid(valid_loader, model, criterion, device)
