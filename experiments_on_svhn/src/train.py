...
from tools.svhn_dataset import SVHNDataset
...
if __name__ == "__main__":
    ...
    # config
    train_dir = os.path.join(BASE_DIR, "..", "data", "svhn_train")
    test_dir = os.path.join(BASE_DIR, "..", "data", "svhn_test")
    ...
    # build Dataset
    train_data = SVHNDataset(train_dir, mode="train", transform=train_transform)
    valid_data = SVHNDataset(train_dir, mode="valid", transform=valid_transform)
    test_data = SVHNDataset(test_dir, mode="test", transform=valid_transform)
